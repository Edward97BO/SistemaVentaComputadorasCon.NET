...
namespace WebComputadorasG3.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(LabComputadorasG3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string? returnUrl = null)
        {
            ...
            var usuario = _context.Usuarios.Include(e => e.IdRolNavigation)
                .Where(x => x.Estado == 1 && x.Nombre == model.usuario &&
                ...
                var claims = new List<Claim>
            {
                ...
                new Claim("FullName", $"{usuario.IdRolNavigation.Nombre} {usuario.IdRolNavigation.Descripcion}"),
                new Claim(ClaimTypes.Email, "itpro@company.bo"),
